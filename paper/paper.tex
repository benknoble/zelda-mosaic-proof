...
For the matrix \textbf{$E$}, each element would be indexed according to the following mapping. Under this scheme, for example, the element $8$ in \textbf{$E$} would have the index $(1, 4, 2)$. This indexing scheme is the general pattern used to access one particular element out of a multi-dimensional array. Note that arrays in \matlab\@ have indices starting at 1.
